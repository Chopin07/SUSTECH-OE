...
HD_PWD='D:/SUSTech/full_adder/full_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source full_adder1.tcl -notrace
