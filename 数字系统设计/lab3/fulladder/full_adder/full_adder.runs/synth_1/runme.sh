...
HD_PWD='D:/SUSTech/full_adder/full_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source full_adder1.tcl
