...
HD_PWD='D:/SUSTech/signal_vare/signal_vare.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log signal_vare.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source signal_vare.tcl
