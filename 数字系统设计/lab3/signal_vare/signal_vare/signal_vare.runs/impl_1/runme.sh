...
HD_PWD='D:/SUSTech/signal_vare/signal_vare.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log signal_vare.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source signal_vare.tcl -notrace
