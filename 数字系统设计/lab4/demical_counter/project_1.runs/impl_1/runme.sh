...
HD_PWD='D:/SUSTech/2026 Spring/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decimal_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decimal_counter.tcl -notrace
