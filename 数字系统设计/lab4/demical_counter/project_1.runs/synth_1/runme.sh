...
HD_PWD='D:/SUSTech/2026 Spring/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decimal_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decimal_counter.tcl
