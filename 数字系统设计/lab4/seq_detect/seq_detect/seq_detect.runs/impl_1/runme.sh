...
HD_PWD='D:/SUSTech/2026 Spring/lab4/seq_detect/seq_detect/seq_detect.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seq_detect.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seq_detect.tcl -notrace
