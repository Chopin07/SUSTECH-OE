...
HD_PWD='D:/SUSTech/2026 Spring/lab5/Fibonacci/Fibonacci/Fibonacci.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fibonacci_fsm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fibonacci_fsm.tcl
