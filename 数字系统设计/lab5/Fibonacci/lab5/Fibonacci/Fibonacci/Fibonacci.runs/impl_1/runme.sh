...
HD_PWD='D:/SUSTech/2026 Spring/lab5/Fibonacci/Fibonacci/Fibonacci.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fibonacci_fsm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fibonacci_fsm.tcl -notrace
